...
@currencyroute.get("/convertation")
async def convertation_page(request: Request, username: str = Depends(get_user_from_cookie)):
    """
    Этот маршрут защищен и требует токен. Выдает страницу с конвертацией валют.
    """
